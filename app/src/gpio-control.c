 ...
 * @brief Contains all logic concerning gpio pin controllers (different to
 * peripheralController gpio functions)
 * @version 0.1
 * @date 2024-11-13
 *
 ...
 * @param af_mode alternative function mode, ignore if mode != alternative
 * function.
